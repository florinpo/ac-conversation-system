...
/* * * $btn_expand ** */
$btn_expand = CHtml::link("<span class='icon-format-2'></span><span>" . t('site', 'Expandi all') . "</span>", 'javascript:void(0)', array('id' => 'expand', 'class' => 'buttonM bDefault wLb btn-toogle floatR hidden'));

/* * * $btn_minimize ** */
$btn_minimize = CHtml::link("<span class='icon-format-4'></span><span>" . t('site', 'Colapse all') . "</span>", 'javascript:void(0)', array('id' => 'minimize', 'class' => 'buttonM bDefault wLb btn-toogle floatR'));
        ...
        foreach ($messages as $k => $msg):
            ...
            <?php if ($k == 1 && count($messages) > 10): ?>
                <li class="items-expand clearfix">
                    ...
                    echo CHtml::link("<span class='icon icon-plus-sign'></span>" . t('site', ':counter other messages', array(':counter' => $counter)), 'javascript:void(0)', array('class' => 'bLink', 'id'=>'show-hidden'));
                    ?>
                </li>
            <?php else: ?>
                    ...
                    <div class='loader-indicator loader-label-30'><span class='loader-txt'><?php echo t('site', 'Caricamento') ?><span></div>
                                ...
                                <div class="expanded clearfix <?php echo $class; ?>">
                                    ...
                                    <div class="data-wrap" id="msg-<?php echo $msg->message_id; ?>">
                                        ...
                                        <div class="actions">
                                            <?php echo CHtml::link("<span class='icon icon-reply'></span>" . t('site', 'Reply'), 'javascript:void(0)', array('class' => 'open-reply')); ?>
                                            <?php
                                            if ($msg->sender_id != user()->id):
                                            ...
                                            echo CHtml::link("<span class='icon icon-remove'></span>" . t('site', 'Delete this message'), 'javascript:void(0)', array('class' => 'msg-btn', 'id' => $delete_type)); ?>
                                            <?php echo CHtml::link("<span class='icon icon-spam'></span>" . t('site', 'Report spam'), 'javascript:void(0)', array('class' => 'msg-btn', 'id' => 'markspam')); ?>
                                        </div>
